...
release=$(sha256sum public/index.html public/marine.html public/birds.html public/data/*.json | sha256sum | cut -c1-16)
sed "s/__RELEASE__/$release/" service-worker.js > public/service-worker.js

for f in public/index.html public/marine.html public/birds.html; do
